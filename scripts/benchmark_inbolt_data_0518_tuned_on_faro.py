...
class ReportGeneratorInbolt(ReportGenerator):
    ...
    def _fig_depth_comparison(self) -> str:
        ...
        fig.suptitle("Depth Map Comparison (12 random frames) — values in meters",
                     fontsize=11, y=1.01)
        fig.tight_layout()
    ...
    def _fig_error_maps(self) -> str:
        ...
        fig.suptitle(f"Absolute Error vs {gt_label} (12 random frames, m)", fontsize=11, y=1.01)
        fig.tight_layout()
...
DEFAULT_OUT     = f'{code_dir}/../reports/benchmark_inbolt_data_0518_tuned_on_faro_kitchen'
#FINETUNED_PATH  = f'{code_dir}/../weights/20-30-48/model_finetuned_faro.pth'
#DEFAULT_OUT     = f'{code_dir}/../reports/benchmark_inbolt_data_0518_tuned_on_faro'
N_VIZ           = 12
