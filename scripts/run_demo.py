...
if __name__=="__main__":
  ...
  parser.add_argument('--left_file', default=f'{code_dir}/../demo_data/left_scene_3.png', type=str)
  parser.add_argument('--right_file', default=f'{code_dir}/../demo_data/rigth_scene_3.png', type=str)
